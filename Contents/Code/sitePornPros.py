...
def search(results,encodedTitle,title,searchTitle,siteNum,lang,searchByDateActor,searchDate,searchAll,searchSiteID):
    url = 'https://pornpros.com/video/' + searchTitle.lower().replace(" ","-")
    ...
    titleNoFormatting = girlName + " - " + titleNoFormatting + " [PornPros, " + releasedDate +"]"
    score = 100
...
def update(metadata,siteID,movieGenres,movieActors):
    ...
    if len(actors) > 0:
        for actorLink in actors:
            actorPageURL = 'https://pornpros.com' + actorLink.get("href")
