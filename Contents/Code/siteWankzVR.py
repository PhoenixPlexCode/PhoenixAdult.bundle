...
def update(metadata,siteID,movieGenres,movieActors):
    ...
    for actorLink in actors:
        ...
        actorPhotoURL = actorPage.xpath('//div[@class="person__avatar"]//source/@srcset')[0].replace('200.webp', '420.jpg')
    ...
    # Posters and artwork
    try:
        art.insert(0, detailsPageElements.xpath('//meta[@property="og:image"]/@content')[0].replace('medium.jpg', 'large.jpg'))
    except:
        pass
